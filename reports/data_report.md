...
- **IslamHouse was verified but not scraped** -- it has a real public API, but book/audio content is PDF/mp3-only (no inline text) and no content-reuse license was found beyond a visitor-privacy policy. See PLAN.md section 8.4.